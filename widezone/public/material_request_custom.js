...
frappe.ui.form.on('Material Request', {
	refresh: function(frm) {
		...
		document.querySelectorAll("[data-fieldname='new_variant']")[1].style.Color ="blue";
    ...
    make_purchase_order: function(frm) {
        ...
        frappe.model.open_mapped_doc({
            method: "lucrum.stock.doctype.material_request.material_request.make_purchase_order",
            frm: frm,
